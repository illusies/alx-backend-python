...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, org, expected, get_patch):
        """
        A function that tests if GithubOrgClient.org returns the
        correct value
        """
    ...
    def test_public_repos_url(self):
        """
        A function that implements unit-tests on the 
    ...
    def test_public_repos(self, get_json_mock):
        """
        A function that implements unit-tests on the public repos
        """
    ...
    def test_has_license(self, repo, license, expected):
        """
        A function that implements unit-tests on the license checker
        """
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    """
    A Class that inherits from unittest.TestCase to implement unit
    tests integration for GithubOrgClient
    """

    @classmethod
    def setupClass(cls):
        """
        A function that starts a patcher name get_patcher that 
        mocks code that sends external requests
        """
    ...
    def tearDownClass(cls):
        """A function that stops the patcher name get_patcher"""
        cls.get_patcher.stop()

    def test_public_repos(self):
        """
        A function that tests GithubOrgClient.public_repos
        and returns the expected results based on the fixtures
        """
        y = GithubOrgClient("x")
    ...
    def test_public_repos_with_license(self):
        """
        A function that tests the public_repos with the argument
        license="apache-2.0" and returns results that matches the
